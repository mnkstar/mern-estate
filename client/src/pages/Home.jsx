    ...
    <div>
      <div className="p-28 px-3 max-w-6xl mx-auto flex flex-col gap-6">
        ...
        <div className="text-slate-700 font-semibold text-xl">
          Get Estate is the best place to find best properties.
          <br />
          Select from our wide range of properties.
        </div>
        <Link
          className="text-xl  text-red-700 font-semibold hover:underline"
          to={"/search"}
        >
